...
from Football import ucl_analysis
...
def main():
    ...
    if sport == "Cricket":
        ...
        if category == "Men's Leagues":
            ...
            format_type = st.sidebar.selectbox("Select Format", ["One Day Internationals", "ODI World Cup", "T20 Internationals", "T20 World Cup"])
            ...
            tournament = st.sidebar.selectbox("Select Tournament", ["Women's Premier League (WPL)", "Women's Big Bash League (WBBL)"])
            ...
            format_type = st.sidebar.selectbox("Select Format", ["One Day Internationals", "T20 Internationals", "Tests", "T20 World Cup", "ODI World Cup"])
    ...
    # ==========================================
        ...
        elif category == "Club Continental":
             tournament = st.sidebar.selectbox("Select Tournament", ["UEFA Champions League"])
             if tournament == "UEFA Champions League": ucl_analysis.run_ucl_analysis()
