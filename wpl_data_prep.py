...
def prep_wpl_data(input_folder, output_filename):
    print(f"👑 Initializing Women's Premier League (WPL) ETL Pipeline...")
    all_balls = []
    ...
    print(f"✅ WPL ETL Complete! Processed {file_count} matches with full scorecard data.")

if __name__ == "__main__":
    INPUT_DIR = "data/WPL_Raw" 
    OUTPUT_FILE = "data/wpl_combined.csv"
    prep_wpl_data(INPUT_DIR, OUTPUT_FILE)