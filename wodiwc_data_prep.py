...
def prep_wodiwc_data(input_folder, output_filename):
    print(f"🏆 Initializing Women's ODI World Cup (WODI WC) ETL Pipeline...")
    all_balls = []
    ...
    if not all_balls:
        print("⚠️ Error: No matches were processed! Please verify that your raw files are inside the 'data/WODIWC_Raw' folder.")
        return

    print("🧩 Merging data and formatting tournament years...")
    ...
    print(f"✅ WODI WC ETL Complete! Processed {file_count} matches successfully.")

if __name__ == "__main__":
    INPUT_DIR = "data/WODIWC_Raw" 
    OUTPUT_FILE = "data/wodiwc_combined.csv"
    prep_wodiwc_data(INPUT_DIR, OUTPUT_FILE)