...
def prep_wodi_data(input_folder, output_filename):
    print(f"🌍 Initializing Women's ODI (WODI) ETL Pipeline...")
    all_balls = []
    ...
    # Safety Net: Check if any data was parsed at all
    if not all_balls:
        print("⚠️ Error: No matches were processed! Please verify that your raw files are inside the 'data/WODI_Raw' folder.")
        return
    ...
    print(f"✅ WODI ETL Complete! Processed {file_count} matches successfully.")

if __name__ == "__main__":
    INPUT_DIR = "data/WODI_Raw" 
    OUTPUT_FILE = "data/wodi_combined.csv"
    prep_wodi_data(INPUT_DIR, OUTPUT_FILE)