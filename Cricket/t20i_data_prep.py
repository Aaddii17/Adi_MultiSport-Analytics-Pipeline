...
def prep_t20i_data(input_folder, output_filename):
    print(f"⚡ Upgrading Men's T20 Internationals ETL Pipeline...")
    all_balls = []
    ...
    print("🧩 Merging T20I data and formatting dates...")
    ...
    print(f"✅ T20I ETL Complete! Processed {file_count} matches with full scorecard data.")

if __name__ == "__main__":
    # Ensure this matches your actual T20I raw folder name
